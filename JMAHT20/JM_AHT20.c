...
static void close(struct AHT20 *self){
...
/*
** @brief THE function used to get temperature fro
*/

static inline float get_temperature(struct AHT20 *self){
...
*/
static inline float get_humidity(struct AHT20 *self){
